...
let roleMover = {
    /** @param {Creep} creep **/
    run: function(creep) {
	let homeRoom = creep.memory.homeRoom || (Game.spawns['Channy'] ? Game.spawns['Channy'].room.name : null);
	...
	const reserveContainerPositions = [
	    ...
	    new RoomPosition(16, 25, creep.room.name),
	    new RoomPosition(18, 25, creep.room.name),
	    new RoomPosition(17, 27, creep.room.name),
	];
