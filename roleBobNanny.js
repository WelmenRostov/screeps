...
let roleBobNanny = {
    run: function(creep) {
        ...
        const homeRoom = creep.memory.homeRoom ||
            (Game.spawns['Bob'] ? Game.spawns['Bob'].room.name : creep.room.name);
        ...
        // ============================================
            ...
            const nannyReservePositions = [
                new RoomPosition(26, 23, homeRoom),
                new RoomPosition(27, 23, homeRoom),
                new RoomPosition(28, 23, homeRoom)
            ];
